...
/// @param storage | A storage containing two hash tables, one that maps names of merchandise to the address of the full information for that merchandise, one that maps names of storage locations to the name of the merchandise stored at that location, and a linked list of shopping carts
...
/// @brief Let the user choose an item from storage, ask for a quantity, let the user choose a shopping cart, then add selected item and quantity to the selected shopping cart
/// @param storage | A storage containing two hash tables, one that maps names of merchandise to the address of the full information for that merchandise, one that maps names of storage locations to the name of the merchandise stored at that location, and a linked list of shopping carts
